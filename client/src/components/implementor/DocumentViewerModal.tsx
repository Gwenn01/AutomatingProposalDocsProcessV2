    ...
    <section className="max-w-5xl mx-auto border border-gray-200 py-5 shadow-sm font-sans text-gray-900 leading-relaxed">
      ...
      <div className="border border-black">
        ...
        <div className=" text-gray-700 leading-relaxed">
          ...
          <div>
            <h3 className="font-bold text-gray-900 pt-10 text-base">VII. SUSTAINABILITY PLAN</h3>
            <p className="text-base mt-3 whitespace-pre-line">{val(projectData.sustainability_plan)}</p>
          </div>
          <div>
            <h3 className="font-bold text-gray-900 pt-10 text-base mb-5">VIII. ORGANIZATION AND STAFFING</h3>
            <table className="w-full border border-black text-sm">
              <tbody>
                <tr className="border-b border-black">
                  <td className="w-1/2 border-r border-black px-4 py-3 text-center font-bold">Name</td>
          ...
          <div>
            <h3 className="font-bold text-gray-900 pt-10 text-base mb-5">IX. WORKPLAN</h3>
            <div className="overflow-x-auto">
              <table className="border border-black text-sm" style={{ minWidth: "900px", width: "100%" }}>
                <tbody>
                  <tr className="border-b border-black">
          ...
          <div>
            <h3 className="font-bold text-gray-900 pt-10 text-base">X. BUDGETARY REQUIREMENT</h3>
            <table className="w-full border border-black text-sm mt-6">
              <tbody>
                <tr className="border-b border-black bg-gray-100">
                  <td className="border-r border-black px-4 py-3 font-bold text-center">Item</td>
