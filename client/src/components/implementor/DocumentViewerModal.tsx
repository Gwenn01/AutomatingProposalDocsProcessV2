...
const ProgramForm: React.FC<{ proposalData: ApiProposalDetail }> = ({ proposalData }) => {
  ...
  return (
    <section className="max-w-5xl mx-auto px-5 py-5 border border-black shadow-sm font-sans text-gray-900 leading-relaxed">
      ...
      <div className="border border-black p-5">
        <h2 className="text-xl font-bold ">I. PROFILE</h2>
        ...
        <div className="overflow-x-auto mt-4">
          <table className="w-full border border-black text-sm">
            <tbody>
              ...
              <tr className="border-b border-black p-5">
        ...
        <p className="font-bold mt-6 mb-2">EXTENSION SITE/S OR VENUE/S</p>
      ...
      <div className="space-y-6 text-gray-700 leading-relaxed">
        <div>
          <h3 className="font-bold text-gray-900 pt-10 text-xl">II. RATIONALE <span className="text-base italic font-semibold">(Include a brief result of the conducted needs assessment.)</span></h3>
    ...
    <section className="max-w-5xl mx-auto px-5 rounded-sm shadow-sm font-sans text-gray-900 leading-relaxed">
      ...
      <div className="overflow-x-auto">
        <table className="w-full border border-black text-sm">
          <tbody>
            <tr className="border-b border-black">
              <td className="w-1/4 border-r border-black px-4 py-3 font-bold">Program Title:</td>
              <td className="px-4 py-3">{val(programTitle)}</td>
            </tr>
            <tr className="border-b border-black">
              <td className="w-1/4 border-r border-black px-4 py-3 font-bold">Project Leader:</td>
              <td className="px-4 py-3">{val(projectData.project_leader)}</td>
            </tr>
            <tr className="border-b border-black">
              <td className="w-1/4 border-r border-black px-4 py-3 font-bold">Project Members:</td>
              <td className="px-4 py-3">{projectData.members?.join(", ") || NA}</td>
            </tr>
            <tr className="border-b border-black">
              <td className="w-1/4 border-r border-black px-4 py-3 font-bold">Project Duration (number of months):</td>
              <td className="px-4 py-3">{val(projectData.duration_months)}</td>
            </tr>
            <tr className="border-b border-black">
              <td className="w-1/4 border-r border-black px-4 py-3 font-bold">Project Start Date:</td>
              <td className="px-4 py-3">{val(projectData.start_date)}</td>
            </tr>
            <tr className="border-b border-black">
              <td className="w-1/4 border-r border-black px-4 py-3 font-bold">Project End Date:</td>
              <td className="px-4 py-3">{val(projectData.end_date)}</td>
            </tr>
            <tr className="border-b border-black">
      ...
      <div className="space-y-6 text-gray-700 leading-relaxed">
        ...
        <div>
          <h3 className="font-bold text-gray-900 pt-10 text-xl mb-5">VIII. ORGANIZATION AND STAFFING</h3>
          <table className="w-full border border-black text-sm">
            <tbody>
              <tr className="border-b border-black">
                <td className="w-1/2 border-r border-black px-4 py-3 text-center font-bold">Name</td>
  ...
  return (
    <section className="max-w-5xl mx-auto px-5 rounded-sm shadow-sm font-sans text-gray-900 leading-relaxed">
      ...
      <div className="overflow-x-auto">
        <table className="w-full border border-black text-sm">
          <tbody>
            ...
            <tr className="border-b border-black">
              <td className="w-1/4 border-r border-black px-4 py-3 font-bold">Project Title:</td>
              <td className="px-4 py-3">{val(projectTitle)}</td>
            </tr>
            <tr className="border-b border-black">
              <td className="w-1/4 border-r border-black px-4 py-3 font-bold">Activity Title:</td>
              <td className="px-4 py-3">{val(activityData.activity_title)}</td>
            </tr>
            <tr className="border-b border-black">
              <td className="w-1/4 border-r border-black px-4 py-3 font-bold">Project Leader:</td>
              <td className="px-4 py-3">{val(activityData.project_leader)}</td>
            </tr>
            <tr className="border-b border-black">
              <td className="w-1/4 border-r border-black px-4 py-3 font-bold">Members:</td>
              <td className="px-4 py-3">{activityData.members?.join(", ") || NA}</td>
            </tr>
            <tr className="border-b border-black">
              <td className="w-1/4 border-r border-black px-4 py-3 font-bold">Activity Duration (hours):</td>
              <td className="px-4 py-3">{val(activityData.activity_duration_hours)}</td>
            </tr>
            <tr className="border-b border-black">
              <td className="w-1/4 border-r border-black px-4 py-3 font-bold">Date:</td>
              <td className="px-4 py-3">{val(activityData.activity_date)}</td>
            </tr>
            <tr className="border-b border-black">
              <td className="w-1/4 border-r border-black px-4 py-3 font-bold">Implementing Agency / College / Mandated Program:</td>
      ...
      <div className="overflow-x-auto mt-6">
        <table className="w-full border border-black text-sm">
          <tbody>
            ...
            <tr className="border-b border-black">
              <td className="border-r border-black px-4 py-3 font-bold">Sustainable Development Goal (SDG) Addressed:</td>
              <td className="px-4 py-3">{val(activityData.sdg_addressed)}</td>
            </tr>
            <tr>
              <td className="border-r border-black px-4 py-3 font-bold">College / Campus / Mandated Academic Program:</td>
      ...
      <div className="space-y-6 text-gray-700 leading-relaxed">
        ...
        <div>
          <h3 className="font-bold text-gray-900 pt-5 text-xl">IV. OBJECTIVES OF THE ACTIVITY</h3>
          <p className="text-base mt-3 whitespace-pre-line">{val(activityData.objectives)}</p>
        </div>
        <div>
          <h3 className="font-bold text-gray-900 pt-10 text-xl">V. METHODOLOGY <span className="text-base italic font-semibold">(short narrative)</span></h3>
        ...
        <div>
          <h3 className="font-bold text-gray-900 pt-10 text-xl mb-5">VII. ORGANIZATION AND STAFFING</h3>
          <table className="w-full border border-black text-sm">
            <tbody>
              <tr className="border-b border-black">
                <td className="w-1/2 border-r border-black px-4 py-3 text-center font-bold">Name</td>
        ...
        <div>
          <h3 className="font-bold text-gray-900 pt-10 text-xl mb-5">VIII. PLAN OF ACTIVITY</h3>
          <table className="w-full border border-black text-sm">
            <tbody>
              <tr className="border-b border-black bg-gray-100">
        ...
        <div>
          <h3 className="font-bold text-gray-900 pt-10 text-xl">IX. BUDGETARY REQUIREMENT</h3>
          <table className="w-full border border-black text-sm mt-6">
            <tbody>
              <tr className="border-b border-black bg-gray-100">
                <td className="border-r border-black px-4 py-3 font-bold text-center">Item</td>
