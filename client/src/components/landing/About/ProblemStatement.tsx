...
const ProblemStatement: React.FC = () => {
  const challenges = [
    ...
    },
    {
      ...
      problem:
        "Monitoring the status of proposals is slow, opaque, and highly inefficient.",
          ...
          <div className="lg:w-1/3 sticky top-12">
            <div className="space-y-6">
              ...
              <h2 className="text-6xl font-black text-slate-900 tracking-[ -0.05em] leading-[0.9]">
                Legacy <br />
                <span className="text-slate-200 group-hover:text-slate-900 transition-colors duration-700">
                  Obstacles.
                </span>
              </h2>
              <p className="text-slate-500 font-medium leading-relaxed max-w-sm">
                Traditional workflows are no longer sustainable for modern
                institutional research. We have identified the core pillars of
          ...
          <div className="lg:w-2/3 space-y-12">
            ...
            <div className="relative group">
              <div className="flex flex-col md:flex-row gap-8 md:items-center">
                <div className="text-8xl font-black text-slate-50 opacity-0 group-hover:opacity-100 transition-opacity duration-500 absolute -left-20 -top-4 pointer-events-none">
                  00
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-lg text-slate-500 leading-relaxed max-w-xl">
                    Manual reviews require physical presence and logistical
                    handling, creating a
              ...
              {challenges.map((item) => (
                <div key={item.id} className="group flex flex-col gap-6">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-[10px] font-mono font-black text-slate-300 uppercase tracking-widest italic">
                      {item.impact}
                    </span>
                  </div>
