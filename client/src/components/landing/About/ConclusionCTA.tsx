...
const ConclusionCTA: React.FC = () => {
  return (
    <section className="relative py-32 bg-[#fafafa] overflow-hidden selection:bg-emerald-100">
      {/* Structural Accent Lines */}
      <div className="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-slate-200 to-transparent" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] border border-white/20 rounded-full pointer-events-none" />

      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-stretch min-h-[500px] rounded-[3.5rem] overflow-hidden shadow-2xl shadow-slate-200/20 border border-white/30">
          {/* Left: Manifesto */}
          <div className="lg:w-3/5 bg-white/50 backdrop-blur-xl p-12 lg:p-20 flex flex-col justify-between relative overflow-hidden border border-white/20 rounded-[3rem]">
            {/* Background Texture */}
            ...
            <div className="space-y-10 relative z-10">
              ...
              <p className="text-slate-700 text-lg font-medium leading-relaxed max-w-md">
                This system digitizes the review lifecycle, supporting{" "}
                <span className="text-slate-900 font-bold underline decoration-emerald-500/30 underline-offset-4">
                  PRMSU Extension Services staff and beneficiaries
                </span>{" "}
                in achieving a high-velocity, synchronized workflow.
              </p>
            </div>
          ...
          {/* Right: Portal */}
          <div className="lg:w-2/5 bg-white/30 backdrop-blur-xl p-12 lg:p-20 flex flex-col items-center justify-center relative overflow-hidden group/portal border border-white/20 rounded-[3rem]">
            {/* Ambient Glow */}
            ...
            <div className="relative z-10 text-center space-y-8">
              <div className="inline-block p-4 rounded-3xl bg-white/10 border border-white/20 backdrop-blur-sm mb-4">
                <Cpu className="text-emerald-400 animate-spin-slow" size={32} />
              </div>

              <div className="space-y-2">
                <h3 className="text-emerald-700 text-2xl font-black uppercase tracking-tighter">
                  Initialize Platform
                </h3>
                <p className="text-emerald-400/50 font-mono text-[10px] uppercase tracking-widest">
