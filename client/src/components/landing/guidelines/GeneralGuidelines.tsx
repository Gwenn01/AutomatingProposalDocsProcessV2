      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col items-center text-center mb-32">
          ...
          <h2 className="text-6xl md:text-8xl font-black text-slate-950 uppercase tracking-tighter leading-none mb-8">
            Universal <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-slate-900 via-emerald-600 to-slate-400 font-light italic">
              Practices.
            </span>
          </h2>
          <p className="max-w-xl text-slate-500 font-medium">
            Operational mandates to ensure data integrity and institutional
            alignment across all user tiers.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-32">
          {practices.map((item, i) => (
            <div
              key={i}
              className={`group relative p-10 rounded-[3rem] bg-white border border-slate-100 shadow-sm transition-all duration-500 hover:-translate-y-4 hover:shadow-2xl hover:shadow-slate-200 ${item.bg}`}
            >
            ...
            <div className="bg-white p-12 rounded-[3.5rem] flex flex-col lg:flex-row items-center justify-between gap-12 shadow-sm">
              <div className="flex flex-col md:flex-row items-center gap-8">
                ...
                <div className="text-center md:text-left">
                  <h5 className="text-2xl font-black text-slate-900 tracking-tight mb-1">
                    Technical Assistance Hub
                  </h5>
                  <p className="text-slate-500 font-medium italic">
                    Graduate School Extension Office | Institutional Support
                  </p>
                </div>
              </div>
