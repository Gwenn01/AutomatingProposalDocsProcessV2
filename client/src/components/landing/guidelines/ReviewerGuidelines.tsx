...
const ReviewerGuidelines: React.FC = () => {
  const statusLogic = [
    {
      state: "For Review",
      trigger: "Newly created by implementor",
      color: "bg-slate-300",
    },
    {
      state: "Under Review",
      trigger: "Admin assigned a reviewer",
      color: "bg-amber-400",
    },
    {
      state: "For Revisions",
      trigger: "Reviewer submitted comments",
      color: "bg-blue-500",
    },
    {
      state: "For Approval",
      trigger: "Admin reviews revisions",
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="mb-20">
          ...
          <h2 className="text-6xl lg:text-8xl font-black text-slate-950 tracking-tighter leading-none mb-8">
            REVIEWER <br />
            <span className="text-emerald-500 italic font-serif lowercase tracking-normal font-light">
              Workflow.
            </span>
          </h2>
          ...
          <div className="max-w-xl">
            <p className="text-lg text-slate-500 font-medium leading-relaxed">
              Assigned users who evaluate proposals. Follow the standard{" "}
              <span className="text-slate-900 font-bold underline decoration-emerald-500/30 text-nowrap">
                Step-by-Step
              </span>{" "}
              review process to maintain system efficiency.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-7 space-y-4">
            {[
              ...
              <div
                key={i}
                className="group flex gap-8 p-10 rounded-[3.5rem] bg-white border border-slate-100 hover:shadow-2xl hover:shadow-slate-200/40 transition-all duration-500"
              >
                ...
                <div className="flex-1 pt-2">
                  <span className="text-[10px] font-mono font-bold text-slate-300 group-hover:text-emerald-500 mb-2 block tracking-widest transition-colors">
                    STEP {item.step}
                  </span>
            ...
            <div className="sticky top-12 space-y-8">
                ...
                <div className="relative z-10">
                  ...
                  <div className="space-y-3">
                    {statusLogic.map((item, i) => (
                      <div
                        key={i}
                        className="flex items-center justify-between p-5 rounded-2xl bg-white/[0.03] border border-white/5 hover:bg-white/[0.07] transition-all group"
                      >
                        <div className="flex items-center gap-4">
                          <div
                            className={`w-1.5 h-1.5 rounded-full ${item.color} shadow-[0_0_10px_currentColor]`}
                          />
                          <div>
                        ...
                        <ChevronRight
                          size={14}
                          className="text-slate-800 group-hover:text-emerald-500 transition-colors"
                        />
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="mt-10 p-6 rounded-3xl bg-emerald-500/10 border border-emerald-500/20 flex gap-4 items-center">
                    ...
                    <p className="text-[10px] font-medium text-slate-300 leading-relaxed italic">
                      Reviewers do{" "}
                      <span className="text-white font-bold uppercase underline decoration-emerald-500/50">
                        not
                      </span>{" "}
                      manually change status. The system updates based on your
                      submitted review.
                    </p>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 gap-4">
                <div className="p-8 rounded-[2.5rem] bg-white border border-slate-100 flex items-start gap-6 group hover:border-emerald-200 transition-all">
                  ...
                  <div>
                    <h5 className="text-[11px] font-black uppercase tracking-widest text-slate-900 mb-1">
                      Clear Feedback
                    </h5>
                    <p className="text-[11px] text-slate-500 font-medium leading-relaxed">
                      Be clear and constructive in comments to help implementors
                      improve.
                    </p>
                  </div>
                </div>
                <div className="p-8 rounded-[2.5rem] bg-white border border-slate-100 flex items-start gap-6 group hover:border-emerald-200 transition-all">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-slate-500 font-medium leading-relaxed">
                      Check previous revisions to avoid repeating feedback
                      cycles.
                    </p>
                  </div>
                </div>
