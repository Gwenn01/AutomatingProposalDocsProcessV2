      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
              ...
              <div className="lg:col-span-7 space-y-8 text-center lg:text-left">
                ...
                <p className="max-w-xl text-slate-400 text-lg font-medium leading-relaxed">
                  These features converge to bridge the gap between
                  institutional policy and digital efficiency. By digitizing the
                  review lifecycle, we don’t just save time—we{" "}
                  <span className="text-emerald-400">eliminate friction</span>{" "}
                  and secure a paperless legacy.
                </p>
                ...
                <div className="flex flex-wrap justify-center lg:justify-start gap-8 pt-4">
                  {[
                    ...
                    <div
                      key={i}
                      className="flex items-center gap-2 text-slate-500 font-bold uppercase text-[10px] tracking-widest"
                    >
              ...
              <div className="lg:col-span-5 flex justify-center lg:justify-end">
                <div className="relative">
                  ...
                  >
                    <Command
                      className="mb-4 opacity-40 group-hover:rotate-90 transition-transform duration-700"
                      size={32}
                    />
        ...
        <div className="mt-16 flex flex-col md:flex-row justify-between items-center gap-6 opacity-40">
          ...
          <div className="flex gap-8">
            <span className="text-[9px] font-black text-slate-900 uppercase tracking-widest cursor-pointer hover:text-emerald-600 transition-colors">
              Privacy Protocol
            </span>
            <span className="text-[9px] font-black text-slate-900 uppercase tracking-widest cursor-pointer hover:text-emerald-600 transition-colors">
              Service Terms
