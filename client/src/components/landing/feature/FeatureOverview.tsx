...
import { Cpu, Fingerprint, Layers, ChevronRight } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 items-end mb-32">
          <div className="lg:col-span-7 space-y-8">
            <div className="inline-flex items-center gap-3 px-3 py-1 rounded-full bg-slate-950">
              ...
              <span className="text-[9px] font-black uppercase tracking-[0.4em] text-emerald-400/80">
                Capabilities v2.0
              </span>
            </div>
          ...
          <div className="lg:col-span-5 pb-2">
            <div className="relative pl-8 border-l-2 border-emerald-500/20">
              <p className="text-xl text-slate-500 font-medium leading-relaxed italic">
                Digitizing the institutional review lifecycle through{" "}
                <span className="text-slate-950">high-precision tools</span>{" "}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <div
              key={i}
              className="group relative bg-white border border-slate-100 p-10 rounded-[2.5rem] transition-all duration-700 hover:shadow-[0_40px_80px_-20px_rgba(0,0,0,0.08)] hover:-translate-y-3"
            >
              {/* Card Decoration */}
