...
const ProcessSection: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Background Ambience */}
      <div
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full max-w-4xl opacity-[0.03] pointer-events-none"
        style={{
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="max-w-3xl mb-24">
          ...
          <h2 className="text-5xl md:text-7xl font-black text-slate-900 tracking-tight leading-[0.95] mb-8">
            Simple. <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-slate-400 italic font-serif">
              Streamlined.
            </span>
          </h2>
          ...
          {steps.map((step, i) => (
            <div key={i} className="group relative">
              ...
              <div className="h-full p-8 rounded-[2.5rem] bg-white border border-slate-100 transition-all duration-500 hover:shadow-[0_40px_80px_-20px_rgba(0,0,0,0.08)] hover:-translate-y-2 relative z-10 flex flex-col">
                ...
                {/* Icon Circle */}
                <div
                  className={`w-12 h-12 rounded-2xl ${step.color} text-white flex items-center justify-center mb-6 shadow-xl shadow-slate-200 transition-transform duration-500 group-hover:rotate-[10deg]`}
                >
                  {step.icon}
                </div>
