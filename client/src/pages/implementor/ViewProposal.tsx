...
interface Review {
  ...
  status: string;
  [key: string]: any; // Allow for additional review properties
}
...
interface Document {
  ...
  reviews: Review[] | number; // Can be array or count
  cover_page?: any;
  full_content?: any;
...
const ViewProposal: React.FC = () => {
  ...
  // Define the unread comments count
  ...
  const handleRead = async (id: string | number): Promise<void> => {
    ...
    // TODO: Implement API call to update notification read status
    try {
      // Placeholder for future API implementation
            ...
            {currentDocuments.map((doc, index) => {
                ...
                >
                    ...
                    <button
                        ...
                        // TODO: Implement API calls to fetch cover page and content
                        // const cover = await getCoverPage(doc.proposal_id);
                        // const content = await getProposalContent(doc.proposal_id);

                        setSelectedDoc({
                            ...doc,
                            cover_page: undefined, // Placeholder
                            full_content: undefined, // Placeholder
                        });
                    ...
                    <button
                        ...
                        // TODO: Implement API call to fetch reviews per document
                        // const reviewsPerDocs = await getReviewsPerDocs(doc.proposal_id);

                        setSelectedDoc({
                            ...doc,
                            reviews_per_docs: undefined, // Placeholder
                        });
