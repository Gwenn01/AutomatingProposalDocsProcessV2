...
from project_proposal.models import ProjectProposalHistory
...
class ActivityProposalHistory(models.Model):
   ...
   proposal = models.ForeignKey(Proposal, on_delete=models.CASCADE, related_name="activity_history")
   project_proposal_history = models.ForeignKey(
        ProjectProposalHistory,
        on_delete=models.CASCADE,
        related_name="activities_history"
    )
   #profile
   activity_title = models.CharField(max_length=255)
